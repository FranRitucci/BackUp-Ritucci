...
ALTER TABLE sales ADD price DECIMAL(6,2);
ALTER TABLE sales ADD item_name VARCHAR(30);
ALTER TABLE sales ADD id_location INT;
...
ALTER TABLE stock_distribution RENAME column quantity TO quantity_location;
